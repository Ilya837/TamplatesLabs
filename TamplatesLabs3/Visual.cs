...
namespace Visual
{
    ...
    class GraphicsAdaptorLinable : AGraphicsAdaptor
    {
        ...
        public void DrawCurve(ICurve c, Graphics g)
        {
            ...
            System.Drawing.Point Point1 = new System.Drawing.Point((Int32)p.GetX(), (Int32)p.GetY());
            System.Drawing.Point Point2 = new System.Drawing.Point();
            ...
            c.GetPoint(1, out tmpPoint);

            DrawPoint(tmpPoint, 4, g);
    ...
    public class VisualFragment : VisualCurve
    {

        private VisualCurve curve;
        private double start, finish;
        public VisualFragment(VisualCurve vCurve, double start,double finish,AGraphicsAdaptor graphicAdaptor) : base(graphicAdaptor)
        {
            this.curve = (VisualCurve)vCurve.GetCopy();
            this.start = start;
            this.finish = finish;
        }
        ...
        public override void Draw(Graphics g)
        {
            GraphicsAdaptorLinable ga2 = new GraphicsAdaptorLinable(this.GetGraphicsAdaptor().GetPen(),1000);
            ga2.DrawCurve(this,g);

        }

        public override ICurve GetCopy()
        {
            return new VisualFragment(curve,start,finish,GetGraphicsAdaptor());
        }
    ...
    public class VisualMoveTo : VisualCurve
    {

        private IPoint p;
        private ICurve curve;
        public VisualMoveTo(ICurve curve, IPoint point, AGraphicsAdaptor graphicAdaptor) : base(graphicAdaptor)
        {
        ...
        public override ICurve GetCopy()
        {
            return new VisualMoveTo(curve, p, GetGraphicsAdaptor());
        }
